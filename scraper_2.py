...
browser = webdriver.Chrome("C:/Users/rakhi/OneDrive/Documents/pythonProjects/Priyanshu/C127/chromedriver.exe")
    ...
    for i in range(1,5):
        while True:
            ...
            if current_page_num < i:
                ...
                browser.find_element("xpath", '//*[@id="primary_column"]/div[1]/div[2]/div[1]/div/nav/span[1]/a').click()
            else:
                break
